...
-- Initial independent announcements schema. Do not point this migration at
-- another product's D1 database.
...
INSERT OR IGNORE INTO feed_state (id, sequence, content_version, key_id)
VALUES (1, 0, 0, '');
